...
3.  **核心大脑 AI**: 填入用于复杂后台任务（如写剧本）的 API URL 和 Key。推荐使用能力较强的模型 (e.g., GPT-4, Gemini Pro)。
4.  **回合裁判 AI**: 填入用于实时指导 AI 回复的 API URL 和 Key。推荐使用响应速度快的模型 (e.g., GPT-3.5-Turbo, Gemini Flash)。**如果此项留空，将自动使用核心大脑的配置。**
5.  点击 **保存并应用所有设置**。
...
这是现阶段最重要的部分。如果您遇到任何问题，请通过以下方式反馈：