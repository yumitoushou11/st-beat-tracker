...
*   **构建规则:**
    ...
    *   **对于\`narrative_goal\` (叙事方向建议 + V2.0 文体建议 - 柔性引导):**
        ...
        *   **V2.0 构建原则（四段式 + 文体建议）:**
            ...
            6.  **【V4.3 新增】噪音事件控制：** 如果当前节拍的描述或退出条件中出现"可能"/"或许"/"轻微"等弱化词，或使用"且"连接的附属触发器（如"且肚子可能叫"），这是**功能性小事件**而非核心冲突。在建议开头添加约束："[事件名称]仅作氛围调节，禁止夸大其严重性，1-2句带过后立即回到[核心议题]。"
        *   **V2.0 范例:**
            ...
            *   (检测到噪音事件: 退出条件含"且肚子可能发出声响") -> \`narrative_goal: "肚子声仅作氛围调节，禁止夸大其严重性，1-2句带过后立即回到核心议题'确认困境共识'。本回合建议推动两人达成'暂时只能待在车上'的共识。"\`
