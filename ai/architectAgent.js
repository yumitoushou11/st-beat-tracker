...
2. **允许内容:**
   - ✅ 纯氛围节拍: 描写环境、天气、氛围的节拍（但必须遵守V12.0反默剧法则）
   - ✅ 心理节拍: 角色独处、反思、内心戏的节拍（但必须遵守V12.0反默剧法则）
...
**【重要】V12.0 反默剧法则（正剧模式也必须严格遵守）:**
- 参见前文"V12.0 反默剧法则 - 死人节拍最多1个！"
- 正剧模式虽然允许氛围和心理节拍,但依然必须遵守死人节拍配额（整章最多1个）
- 即使是pause章节,也必须保证至少有对话/第二声音/NPC互动
...
- **\`silence_check_report\`**: "【必填】逐个列举每个节拍的对话/声音来源,最后统计死人节拍总数（必须<=1）"
`}
