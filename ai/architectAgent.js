  ...
  "chapter_blueprint": {
    ...
    "chapter_core_and_highlight": {
      ...
      "highlight_design_logic": {
        ...
        "amplification_technique": "[你用了什么手段？例如：'时间拉伸'、'感官剥夺']",
        "unique_execution": "[具体怎么写的？**重点：**描述画面细节（碎裂的杯子、颤抖的瞳孔），而不是描述心理活动或对话内容。]", // 修改了提示
        "emotional_impact_goal": "[预期的效果：让玩家感到困惑/震撼/窒息，而不是获得信息]" // 修改了提示
      },
      "highlight_directive": {
        "target_beat": "[高光节拍ID]",
...
"highlight_design_logic": {
  ...
  "unique_execution": "[具体怎么写的？例如：'在主角触碰神器的瞬间，我不描写光效，而是描写他突然听到了千年前古战场的嘶吼声，并将眼前人的脸与记忆中模糊的神明面孔重叠。']",
