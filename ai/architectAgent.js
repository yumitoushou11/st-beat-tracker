...
**示例对比：**
❌ **低质量节拍:** "主角参加考核，通过了测试。"
✅ **高质量网文节拍:** "主角在众人轻蔑的目光中（压抑），轻描淡写地完成了连导师都觉得困难的测试（反转），检测水晶直接爆表，全场哗然，导师当场收他为亲传弟子（爽点+奖励）。"
...
**3. 转（2-3节拍）:** 意外/冲突/反转（核心爽点集中区，必须有预期差爆发）
**4. 合（1-2节拍）:** 暂时解决，收获**实质性奖励**（物品/地位/信息/美人）
...
\`\`\`json
{
  "design_notes": {
    ...
    "satisfaction_blueprint": {
      "core_pleasure_source": "[【V7.1 网文模式必填】本章的核心快感来源，例如：'扮猪吃虎'、'人前显圣'、'收获重宝'、'复仇成功'、'身份反转'。如果是正剧模式，填写'N/A（正剧模式不适用）']",
      "expectation_setup": "[【V7.1 网文模式必填】你是如何铺垫预期差的？例如：'让反派先嘲讽主角是废柴'、'让围观者低估主角实力'。如果是正剧模式，填写'N/A']",
      "climax_payoff": "[【V7.1 网文模式必填】高潮时刻的反馈是什么？例如：'主角展示神兽，反派跪地求饶，围观群众惊掉下巴'、'主角一招秒杀BOSS，全场震撼'。如果是正剧模式，填写'N/A']",
      "tangible_rewards": [
        "[【V7.1 网文模式必填】具体的物质/能力奖励，例如：'获得S级技能书'、'收服稀有魔兽'、'得到美人青睐'。如果是正剧模式，填写'N/A']"
      ],
      "emotional_rewards": "[【V7.1 网文模式必填】情绪价值奖励，例如：'获得高冷NPC的彻底臣服'、'被大人物当众认可'、'让曾经轻视自己的人跪求原谅'。如果是正剧模式，填写'N/A']",
      "hook_design": "[【V7.1 网文模式必填】本章结尾抛出的钩子是什么？类型是悬念型/冲突型/欲望型？例如：'宝物内部封印着未知存在（悬念型）'、'输家派刺客尾随（冲突型）'、'大人物提出危险任务（欲望型）'。如果是正剧模式，填写'N/A']"
    },
