...
第一章_反机械降神铁律_V13.1:
  ...
  三大禁令:
    ...
    禁令3_莫名钩子: 终章信标必须从本章内容自然延伸，严禁用无关事件作为钩子
...
第四章_最终输出指令:
  ...
  规范2_结尾逻辑_The_Art_of_the_Cut:
    ...
    终章信标Endgame_Beacon: 描述最后节拍之后T加1时刻发生的无歧义的可观测事件
      悬崖模式下的信标: 必须是静止的张力例如环境的空镜如火星熄灭僵持的动作如伸在半空的手或打破死寂的突兀声响如心跳声远处的钟声绝对禁止描写缓解尴尬的动作如喝水咳嗽坐下
      反钩模式下的信标: 先用一笔巩固落地后的秩序紧接着呈现反向张力的第一个可观测征兆例如灯灭后的暗影脚步告别后立即弹出的新密讯让读者意识到真正的危机即将反扑
      核心铁律: 信标必须是新内容严禁重复最后节拍的内容
